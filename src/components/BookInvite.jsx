...
const PAGES = [
  {
    top: <div className="content"><img className="image-1" src="images/page-1-top.png" /></div>,
    bottom: (
      <div className="content">
        <h2>We cordially invite you to this special occasion</h2>
      </div>
    )
  },
  {
    top: <div className="content"><img className="image-1" src="images/page-2-top.png" /></div>,
    bottom: (
      <div className="content">
        <h2>Reception :</h2>
  ...
  {
    top: <div className="content"><img className="image-1" src="images/page-3-top.png" /></div>,
    bottom: (
      <div className="content">
...
const BookInvite = () => {
  ...
  return (
    <div className="invite-wrapper">
      ...
      <div className="book">
        <div className="page page-up" onClick={handleTopPageClick}>{PAGES[currentPage].top}</div>
